...
29. 泛型：
    ...
    - JVM如何理解泛型概念——类型擦除。事实上，JVM并不知道泛型，所有的泛型在编译阶段就已经被处理成了普通类和方法。处理方法很简单，叫做类型变量T的擦除(erased)
...
33. Exceptions:
    ...
    ![Screen Shot 2017-09-12 at 2.58.59 pm](https://ws1.sinaimg.cn/large/006tKfTcgy1fjgoz4jkvhj30ke14kq5w.jpg)
